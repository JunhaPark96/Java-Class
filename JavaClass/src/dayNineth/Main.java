...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        /*
         * 2. 결과: y1.a(): "Aa", y2.a(): "Bb" 2. 이유: 상위 추상클래스 Y를 다운캐스팅하였고, Y는 인터페이스 X를 구현하였다.
         * X의 추상메소드 void a() -> Y의 추상메소드 public abstract void a(); -> 각 A, B에 대한 오버라이드 void a() 실행
         */
        ...
        /*
         * 3. 결과: Y를 배열변수 타입으로 한 결과 "Ab", "Bb"
         * 3. 이유: Y에 공통된 추상메소드 b()가 있으니까. 만약 X로 타입을 넣으면 b() 메소드가 없기 때문에 오류가난다
         */
