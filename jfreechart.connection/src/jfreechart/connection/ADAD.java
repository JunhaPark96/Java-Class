...
//        ResultSet rs = null;
//        String queryTop5 =
//                "SELECT * FROM 행복지수 WHERE year = 2018 ORDER BY rank ASC FETCH FIRST 5 ROWS ONLY";
//        String queryBottom5 =
//                "SELECT * FROM 행복지수 WHERE year = 2018 ORDER BY rank DESC FETCH FIRST 5 ROWS ONLY";
//        try {
...
//                double happinessTop =
//                        gdp + socialSupport + healthyLife + freedom + generosity - corruption;
...
//
//            // 그래프 생성
//            JFreeChart chart = ChartFactory.createStackedBarChart3D("행복지수 상위 5개국과 하위 5개국 비교", "국가",
//                    "행복지수", dataset);
//            chart.getCategoryPlot().getDomainAxis()
//                    .setCategoryLabelPositions(CategoryLabelPositions.UP_90); // 90도 회전
//
